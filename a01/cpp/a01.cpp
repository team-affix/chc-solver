...
bool a01::sim_one(monte_carlo::tree_node<decider::choice>& root, a01_decision_store& ds, a01_resolution_store& rs) {
    // reset the trail
    t.pop();
    t.push();

    // construct the simulation
    monte_carlo::simulation<decider::choice, std::mt19937> sim(root, c, rng);
